...
{!showFilters && <i className="ri-equalizer-fill text-xl cursor-pointer"
...
className="border border-gray-300 rounded border-solid px-2 py-1 h-14 w-full" />
   ...
   {products?.map((product)=> {
      ...
      <div className="border border-gray-300 rounded border-solid flex flex-col gap-2 pb-2 cursor-pointer" key={product._id}
      ...
      <div className="px-2 flex flex-col">
        ...
        {product.age === 1 ? " year" : " years"} {' '}old</p>
        <Divider />
